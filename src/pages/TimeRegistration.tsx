  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen >
        ...
        <form>
          <IonInput placeholder="Start time" style={{ textAlign: "center" }}></IonInput>
          <IonInput placeholder="End time" style={{ textAlign: "center" }}></IonInput>

          <div style={{ textAlign: "center", justifyContent: "center", display: "grid", alignContent: "center" }}>
            <select name="noget" id="noget" >
              <option value="noget" selected>Choose activity</option>
          ...
          <IonTextarea placeholder="Comments" style={{ textAlign: "center" }}></IonTextarea>
